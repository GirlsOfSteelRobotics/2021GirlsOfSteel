    ...
    private class SuperstructureSendable implements Sendable {
        ...
        public void initSendable(SendableBuilder builder) {
            ...
            builder.addDoubleProperty(
                    "HoodAngle", m_shooter::getHoodAngle, null);
            builder.addDoubleProperty(
                    "HoodMotorSpeed", m_shooter::getHoodMotorSpeed, null);
            builder.addDoubleProperty(
                    "ShooterMotorSpeed", m_shooter::getShooterMotorSpeed, null);
            builder.addBooleanProperty(
                    "CollectorIn", m_collector::getCollectorIn, null);
            builder.addDoubleProperty(
                    "CollectorSpeed", m_collector::getCollectorSpeed, null);
        }
    }
}
